...
protected:
  ...
  void Initialize( mitk::RenderingManager* renderingManager = nullptr, const char* name = "unnamed renderer",mitk::BaseRenderer::RenderingMode::Type renderingMode = mitk::BaseRenderer::RenderingMode::Standard );
  void Destroy();
